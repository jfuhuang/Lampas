    ...
    <div className="flex flex-1 flex-col gap-6 py-6">
      ...
      <div className="mt-auto flex flex-col gap-2">
        {confirming ? (
          <>
            <p className="text-center text-sm font-bold text-red-300">
              A seeker's light hit you? This converts your WHOLE team to seekers.
            </p>
        ...
        <p className="text-center text-xs text-neutral-600">
          Team: {you.teamName} · Keep this screen dim &amp; face-down while hiding
        </p>
      </div>
    </div>
  );
...
export function GameOver() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 py-10 text-center">
      ...
      <p className="text-sm text-neutral-400">Waiting for the host to reset to lobby…</p>
    </div>
  );
}
